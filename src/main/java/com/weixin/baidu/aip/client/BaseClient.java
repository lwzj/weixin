 ...
 */
package com.weixin.baidu.aip.client;


import com.weixin.baidu.aip.auth.CloudAuth;
import com.weixin.baidu.aip.auth.DevAuth;
import com.weixin.baidu.aip.error.AipError;
import com.weixin.baidu.aip.http.*;
import com.weixin.baidu.aip.util.AipClientConfiguration;
import com.weixin.baidu.aip.util.AipClientConst;
import com.weixin.baidu.aip.util.SignUtil;
